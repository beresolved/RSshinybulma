...
#' 
#' @export
bulmaButton <- function(..., inputId = NULL, color = NULL, style = NULL, class = NULL, rounded = FALSE, size = NULL, display = NULL, tag = shiny::tags$a){
  ...
  cl <- paste("button", color, size, display, class, rounded)
